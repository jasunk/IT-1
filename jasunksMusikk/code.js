let inputEle = document.querySelector(".inputAlbum");
let inputEle2 = document.querySelector(".inputBand");
...
submitEle.onclick = function() {
    if((inputEle.value !== "")&&(inputEle2.value!== "")) {
        addTaskToArray(inputEle.value + "  -  " + inputEle2.value);
        inputEle.value ="";
        inputEle2.value="";
    }
}
